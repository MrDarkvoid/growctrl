var lt=globalThis,ct=lt.ShadowRoot&&(lt.ShadyCSS===void 0||lt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,vt=Symbol(),ne=new WeakMap,J=class{constructor(t,e,s){if(this._$cssResult$=!0,s!==vt)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o,e=this.t;if(ct&&t===void 0){let s=e!==void 0&&e.length===1;s&&(t=ne.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),s&&ne.set(e,t))}return t}toString(){return this.cssText}},re=n=>new J(typeof n=="string"?n:n+"",void 0,vt),Y=(n,...t)=>{let e=n.length===1?n[0]:t.reduce((s,i,r)=>s+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+n[r+1],n[0]);return new J(e,n,vt)},oe=(n,t)=>{if(ct)n.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(let e of t){let s=document.createElement("style"),i=lt.litNonce;i!==void 0&&s.setAttribute("nonce",i),s.textContent=e.cssText,n.appendChild(s)}},$t=ct?n=>n:n=>n instanceof CSSStyleSheet?(t=>{let e="";for(let s of t.cssRules)e+=s.cssText;return re(e)})(n):n;var{is:Me,defineProperty:Ie,getOwnPropertyDescriptor:Ne,getOwnPropertyNames:Be,getOwnPropertySymbols:De,getPrototypeOf:He}=Object,dt=globalThis,ae=dt.trustedTypes,Ue=ae?ae.emptyScript:"",Ge=dt.reactiveElementPolyfillSupport,tt=(n,t)=>n,_t={toAttribute(n,t){switch(t){case Boolean:n=n?Ue:null;break;case Object:case Array:n=n==null?n:JSON.stringify(n)}return n},fromAttribute(n,t){let e=n;switch(t){case Boolean:e=n!==null;break;case Number:e=n===null?null:Number(n);break;case Object:case Array:try{e=JSON.parse(n)}catch{e=null}}return e}},ce=(n,t)=>!Me(n,t),le={attribute:!0,type:String,converter:_t,reflect:!1,useDefault:!1,hasChanged:ce};Symbol.metadata??=Symbol("metadata"),dt.litPropertyMetadata??=new WeakMap;var I=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=le){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(t,e),!e.noAccessor){let s=Symbol(),i=this.getPropertyDescriptor(t,s,e);i!==void 0&&Ie(this.prototype,t,i)}}static getPropertyDescriptor(t,e,s){let{get:i,set:r}=Ne(this.prototype,t)??{get(){return this[e]},set(o){this[e]=o}};return{get:i,set(o){let c=i?.call(this);r?.call(this,o),this.requestUpdate(t,c,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??le}static _$Ei(){if(this.hasOwnProperty(tt("elementProperties")))return;let t=He(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(tt("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(tt("properties"))){let e=this.properties,s=[...Be(e),...De(e)];for(let i of s)this.createProperty(i,e[i])}let t=this[Symbol.metadata];if(t!==null){let e=litPropertyMetadata.get(t);if(e!==void 0)for(let[s,i]of e)this.elementProperties.set(s,i)}this._$Eh=new Map;for(let[e,s]of this.elementProperties){let i=this._$Eu(e,s);i!==void 0&&this._$Eh.set(i,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){let e=[];if(Array.isArray(t)){let s=new Set(t.flat(1/0).reverse());for(let i of s)e.unshift($t(i))}else t!==void 0&&e.push($t(t));return e}static _$Eu(t,e){let s=e.attribute;return s===!1?void 0:typeof s=="string"?s:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??=new Set).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){let t=new Map,e=this.constructor.elementProperties;for(let s of e.keys())this.hasOwnProperty(s)&&(t.set(s,this[s]),delete this[s]);t.size>0&&(this._$Ep=t)}createRenderRoot(){let t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return oe(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,s){this._$AK(t,s)}_$ET(t,e){let s=this.constructor.elementProperties.get(t),i=this.constructor._$Eu(t,s);if(i!==void 0&&s.reflect===!0){let r=(s.converter?.toAttribute!==void 0?s.converter:_t).toAttribute(e,s.type);this._$Em=t,r==null?this.removeAttribute(i):this.setAttribute(i,r),this._$Em=null}}_$AK(t,e){let s=this.constructor,i=s._$Eh.get(t);if(i!==void 0&&this._$Em!==i){let r=s.getPropertyOptions(i),o=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:_t;this._$Em=i;let c=o.fromAttribute(e,r.type);this[i]=c??this._$Ej?.get(i)??c,this._$Em=null}}requestUpdate(t,e,s,i=!1,r){if(t!==void 0){let o=this.constructor;if(i===!1&&(r=this[t]),s??=o.getPropertyOptions(t),!((s.hasChanged??ce)(r,e)||s.useDefault&&s.reflect&&r===this._$Ej?.get(t)&&!this.hasAttribute(o._$Eu(t,s))))return;this.C(t,e,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,e,{useDefault:s,reflect:i,wrapped:r},o){s&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,o??e??this[t]),r!==!0||o!==void 0)||(this._$AL.has(t)||(this.hasUpdated||s||(e=void 0),this._$AL.set(t,e)),i===!0&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}let t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[i,r]of this._$Ep)this[i]=r;this._$Ep=void 0}let s=this.constructor.elementProperties;if(s.size>0)for(let[i,r]of s){let{wrapped:o}=r,c=this[i];o!==!0||this._$AL.has(i)||c===void 0||this.C(i,void 0,r,c)}}let t=!1,e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),this._$EO?.forEach(s=>s.hostUpdate?.()),this.update(e)):this._$EM()}catch(s){throw t=!1,this._$EM(),s}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach(e=>this._$ET(e,this[e])),this._$EM()}updated(t){}firstUpdated(t){}};I.elementStyles=[],I.shadowRootOptions={mode:"open"},I[tt("elementProperties")]=new Map,I[tt("finalized")]=new Map,Ge?.({ReactiveElement:I}),(dt.reactiveElementVersions??=[]).push("2.1.2");var Tt=globalThis,de=n=>n,pt=Tt.trustedTypes,pe=pt?pt.createPolicy("lit-html",{createHTML:n=>n}):void 0,be="$lit$",N=`lit$${Math.random().toFixed(9).slice(2)}$`,xe="?"+N,Ve=`<${xe}>`,j=document,st=()=>j.createComment(""),it=n=>n===null||typeof n!="object"&&typeof n!="function",Lt=Array.isArray,je=n=>Lt(n)||typeof n?.[Symbol.iterator]=="function",wt=`[ 	
\f\r]`,et=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,he=/-->/g,ge=/>/g,G=RegExp(`>|${wt}(?:([^\\s"'>=/]+)(${wt}*=${wt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ue=/'/g,me=/"/g,ye=/^(?:script|style|textarea|title)$/i,Ft=n=>(t,...e)=>({_$litType$:n,strings:t,values:e}),l=Ft(1),ot=Ft(2),_s=Ft(3),W=Symbol.for("lit-noChange"),d=Symbol.for("lit-nothing"),fe=new WeakMap,V=j.createTreeWalker(j,129);function ve(n,t){if(!Lt(n)||!n.hasOwnProperty("raw"))throw Error("invalid template strings array");return pe!==void 0?pe.createHTML(t):t}var We=(n,t)=>{let e=n.length-1,s=[],i,r=t===2?"<svg>":t===3?"<math>":"",o=et;for(let c=0;c<e;c++){let a=n[c],h,g,f=-1,_=0;for(;_<a.length&&(o.lastIndex=_,g=o.exec(a),g!==null);)_=o.lastIndex,o===et?g[1]==="!--"?o=he:g[1]!==void 0?o=ge:g[2]!==void 0?(ye.test(g[2])&&(i=RegExp("</"+g[2],"g")),o=G):g[3]!==void 0&&(o=G):o===G?g[0]===">"?(o=i??et,f=-1):g[1]===void 0?f=-2:(f=o.lastIndex-g[2].length,h=g[1],o=g[3]===void 0?G:g[3]==='"'?me:ue):o===me||o===ue?o=G:o===he||o===ge?o=et:(o=G,i=void 0);let m=o===G&&n[c+1].startsWith("/>")?" ":"";r+=o===et?a+Ve:f>=0?(s.push(h),a.slice(0,f)+be+a.slice(f)+N+m):a+N+(f===-2?c:m)}return[ve(n,r+(n[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),s]},nt=class n{constructor({strings:t,_$litType$:e},s){let i;this.parts=[];let r=0,o=0,c=t.length-1,a=this.parts,[h,g]=We(t,e);if(this.el=n.createElement(h,s),V.currentNode=this.el.content,e===2||e===3){let f=this.el.content.firstChild;f.replaceWith(...f.childNodes)}for(;(i=V.nextNode())!==null&&a.length<c;){if(i.nodeType===1){if(i.hasAttributes())for(let f of i.getAttributeNames())if(f.endsWith(be)){let _=g[o++],m=i.getAttribute(f).split(N),y=/([.?@])?(.*)/.exec(_);a.push({type:1,index:r,name:y[2],strings:m,ctor:y[1]==="."?kt:y[1]==="?"?At:y[1]==="@"?Ct:X}),i.removeAttribute(f)}else f.startsWith(N)&&(a.push({type:6,index:r}),i.removeAttribute(f));if(ye.test(i.tagName)){let f=i.textContent.split(N),_=f.length-1;if(_>0){i.textContent=pt?pt.emptyScript:"";for(let m=0;m<_;m++)i.append(f[m],st()),V.nextNode(),a.push({type:2,index:++r});i.append(f[_],st())}}}else if(i.nodeType===8)if(i.data===xe)a.push({type:2,index:r});else{let f=-1;for(;(f=i.data.indexOf(N,f+1))!==-1;)a.push({type:7,index:r}),f+=N.length-1}r++}}static createElement(t,e){let s=j.createElement("template");return s.innerHTML=t,s}};function q(n,t,e=n,s){if(t===W)return t;let i=s!==void 0?e._$Co?.[s]:e._$Cl,r=it(t)?void 0:t._$litDirective$;return i?.constructor!==r&&(i?._$AO?.(!1),r===void 0?i=void 0:(i=new r(n),i._$AT(n,e,s)),s!==void 0?(e._$Co??=[])[s]=i:e._$Cl=i),i!==void 0&&(t=q(n,i._$AS(n,t.values),i,s)),t}var St=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:e},parts:s}=this._$AD,i=(t?.creationScope??j).importNode(e,!0);V.currentNode=i;let r=V.nextNode(),o=0,c=0,a=s[0];for(;a!==void 0;){if(o===a.index){let h;a.type===2?h=new rt(r,r.nextSibling,this,t):a.type===1?h=new a.ctor(r,a.name,a.strings,this,t):a.type===6&&(h=new Et(r,this,t)),this._$AV.push(h),a=s[++c]}o!==a?.index&&(r=V.nextNode(),o++)}return V.currentNode=j,i}p(t){let e=0;for(let s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}},rt=class n{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,s,i){this.type=2,this._$AH=d,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=q(this,t,e),it(t)?t===d||t==null||t===""?(this._$AH!==d&&this._$AR(),this._$AH=d):t!==this._$AH&&t!==W&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):je(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==d&&it(this._$AH)?this._$AA.nextSibling.data=t:this.T(j.createTextNode(t)),this._$AH=t}$(t){let{values:e,_$litType$:s}=t,i=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=nt.createElement(ve(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===i)this._$AH.p(e);else{let r=new St(i,this),o=r.u(this.options);r.p(e),this.T(o),this._$AH=r}}_$AC(t){let e=fe.get(t.strings);return e===void 0&&fe.set(t.strings,e=new nt(t)),e}k(t){Lt(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,s,i=0;for(let r of t)i===e.length?e.push(s=new n(this.O(st()),this.O(st()),this,this.options)):s=e[i],s._$AI(r),i++;i<e.length&&(this._$AR(s&&s._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){let s=de(t).nextSibling;de(t).remove(),t=s}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},X=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,i,r){this.type=1,this._$AH=d,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=r,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=d}_$AI(t,e=this,s,i){let r=this.strings,o=!1;if(r===void 0)t=q(this,t,e,0),o=!it(t)||t!==this._$AH&&t!==W,o&&(this._$AH=t);else{let c=t,a,h;for(t=r[0],a=0;a<r.length-1;a++)h=q(this,c[s+a],e,a),h===W&&(h=this._$AH[a]),o||=!it(h)||h!==this._$AH[a],h===d?t=d:t!==d&&(t+=(h??"")+r[a+1]),this._$AH[a]=h}o&&!i&&this.j(t)}j(t){t===d?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},kt=class extends X{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===d?void 0:t}},At=class extends X{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==d)}},Ct=class extends X{constructor(t,e,s,i,r){super(t,e,s,i,r),this.type=5}_$AI(t,e=this){if((t=q(this,t,e,0)??d)===W)return;let s=this._$AH,i=t===d&&s!==d||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,r=t!==d&&(s===d||i);i&&this.element.removeEventListener(this.name,this,s),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},Et=class{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){q(this,t)}};var Ze=Tt.litHtmlPolyfillSupport;Ze?.(nt,rt),(Tt.litHtmlVersions??=[]).push("3.3.3");var $e=(n,t,e)=>{let s=e?.renderBefore??t,i=s._$litPart$;if(i===void 0){let r=e?.renderBefore??null;s._$litPart$=i=new rt(t.insertBefore(st(),r),r,void 0,e??{})}return i._$AI(n),i};var Pt=globalThis,R=class extends I{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=$e(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return W}};R._$litElement$=!0,R.finalized=!0,Pt.litElementHydrateSupport?.({LitElement:R});var Ke=Pt.litElementPolyfillSupport;Ke?.({LitElement:R});(Pt.litElementVersions??=[]).push("4.2.2");var _e,ht=null;function gt(n){if(n?.states===_e&&ht)return ht;let t=new Map,e=new Set,s={};for(let[i,r]of Object.entries(n?.states??{})){let o=r?.attributes;if(!o?.growctrl_role||!o?.growctrl_tent)continue;let c=String(o.growctrl_tent),a=String(o.growctrl_station??"zelt");t.set(`${c}::${a}::${o.growctrl_role}`,i),a==="zelt"?e.add(c):(s[c]??=new Set).add(a)}return _e=n?.states,ht={tents:[...e].sort(),stations:Object.fromEntries(Object.entries(s).map(([i,r])=>[i,[...r].sort()])),byRole:t},ht}var Z=(n,t,e,s)=>gt(n).byRole.get(`${t}::${e}::${s}`);var $=class extends R{constructor(){super(...arguments);this._config={};this._label=e=>e.label??e.name}static{this.properties={hass:{attribute:!1},_config:{state:!0}}}static{this.styles=Y`
...
`,z={ok:{bg:"rgba(77,255,195,.14)",color:u.ok,label:"Alles OK"},info:{bg:"rgba(126,200,255,.14)",color:u.info,label:"Info"},warning:{bg:"rgba(255,209,102,.16)",color:u.warn,label:"Warnung"},critical:{bg:"rgba(255,107,107,.18)",color:u.crit,label:"Fehler"}};var D=30,ft=4,Fe=6,Rt=14,qe=0;function Xe(n){if(n.length<3)return`M${n.map(e=>e.join(",")).join(" L")}`;let t=`M${n[0][0]},${n[0][1]}`;for(let e=0;e<n.length-1;e++){let s=n[Math.max(0,e-1)],i=n[e],r=n[e+1],o=n[Math.min(n.length-1,e+2)],c=i[0]+(r[0]-s[0])/6,a=i[1]+(r[1]-s[1])/6,h=r[0]-(o[0]-i[0])/6,g=r[1]-(o[1]-i[1])/6;t+=` C${c.toFixed(1)},${a.toFixed(1)} ${h.toFixed(1)},${g.toFixed(1)} ${r[0]},${r[1]}`}return t}function H(n,t={}){let e=`gcg${qe++}`,s=t.w??300,i=t.h??110,r=n.flatMap(m=>m.data);if(!r.length)return l`<div style="height:${i}px;display:flex;align-items:center;justify-content:center;
    font-size:11px;color:rgba(255,255,255,.5)">Keine Verlaufsdaten</div>`;let o=t.min??Math.min(...r,t.band?.min??1/0),c=t.max??Math.max(...r,t.band?.max??-1/0);c-o<.001&&(c+=1,o-=1);let a=(c-o)*.08;o-=a,c+=a;let h=(m,y)=>D+m/Math.max(1,y-1)*(s-D-ft),g=m=>Fe+(1-(m-o)/(c-o))*(i-Fe-Rt),f=t.grid??3,_=m=>Math.abs(m)>=100?m.toFixed(0):Math.abs(m)>=10?m.toFixed(1):m.toFixed(2);return l`<svg data-gce="4d724461726b766f6964" viewBox="0 0 ${s} ${i}" preserveAspectRatio="none" style="width:100%;height:${i}px;display:block">
    ${t.band&&(t.band.min!==void 0||t.band.max!==void 0)?ot`
      <rect x="${D}" y="${g(t.band.max??c)}" width="${s-D-ft}"
        height="${Math.max(0,g(t.band.min??o)-g(t.band.max??c))}"
        fill="${t.band.color??"rgba(77,255,195,.08)"}" />`:d}
    ${Array.from({length:f+1},(m,y)=>{let v=o+(c-o)*y/f;return ot`
        <line x1="${D}" y1="${g(v)}" x2="${s-ft}" y2="${g(v)}"
          stroke="rgba(255,255,255,.10)" stroke-width="1"/>
        <text x="${D-4}" y="${g(v)+3}" text-anchor="end"
          font-size="9.5" fill="rgba(255,255,255,.68)">${_(v)}</text>`})}
    ${n.map((m,y)=>{if(m.data.length<2)return d;let v=m.data.map((O,b)=>[Number(h(b,m.data.length).toFixed(1)),Number(g(O).toFixed(1))]),L=Xe(v),E=v[v.length-1][0],F=v[v.length-1][1];return ot`
        <defs>
          <linearGradient id="${e}-${y}" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stop-color="${m.color}" stop-opacity=".18"/>
        ...
        ${m.fill!==!1?ot`<path
          ...
          fill="url(#${e}-${y})"/>`:d}
        <path d="${L}" fill="none" stroke="${m.color}" stroke-width="2.4"
          stroke-linejoin="round" stroke-linecap="round"/>
        <circle cx="${E}" cy="${F}" r="6" fill="${m.color}" opacity=".18"/>
        <circle cx="${E}" cy="${F}" r="3" fill="${m.color}"/>
        <circle cx="${E}" cy="${F}" r="1.3" fill="rgba(10,14,18,.9)"/>`})}
    <text x="${D}" y="${i-3}" font-size="9" fill="rgba(255,255,255,.5)">-24h</text>
    <text x="${s-ft}" y="${i-3}" text-anchor="end" font-size="9" fill="rgba(255,255,255,.5)">jetzt</text>
  </svg>`}var Pe=n=>l`
  <div style="display:flex;gap:12px;flex-wrap:wrap;margin-top:4px">
    ${n.filter(t=>t.name).map(t=>l`<span style="display:inline-flex;align-items:center;gap:5px;
    ...
    </div>`}render(){let e=this._config;if(!this.hass)return d;let s=this.hass.states[this.e("vpd")],i=!s&&!this.hass.states[this.e("enabled")],r=k(s?.state)??(i?1.06:null),o=s?.attributes?.temp,c=s?.attributes?.rh,a=s?.attributes?.phase_effektiv??"Veg",h=s?.attributes?.sollwerte,g=this.isOn(this.e("enabled")),f=this.isOn(this.e("climate")),_=this.hass.states[this.e("status")],m=_?.attributes?.probleme??[],y=_?.state?.toLowerCase?.()==="problem"?"warning":g?"ok":"none",v=z[y]??z.none,L=this.hass.states[this.e("event")],E=r!==null&&h&&r>=h.vpd_min&&r<=h.vpd_max,F=(b,T,C,A)=>l`
      <button class="gc" style="flex:1;display:flex;align-items:center;justify-content:center;gap:7px;
        ...
        <ha-icon .icon=${A} style="--mdc-icon-size:15px"></ha-icon>
        <span style="font-size:11px;font-weight:800">${T} ${C?"AN":"AUS"}</span>
      </button>`,O=(b,T,C,A)=>l`
      <div class="tile" style="text-align:center">
        <div class="lbl">${b}</div>
        <div class="val" style="font-size:22px;${A?`color:${A}`:""}">${T}<span class="unit">${C}</span></div>
      </div>`;return l`<div class="card ${e.style?.glass?"glass":""}" data-level=${y==="none"?"ok":y}
      ...
      <div class="kpis cols-3" style="margin-top:10px">
        ${O("Temperatur",o!=null?Number(o).toFixed(1):"\u2013","\xB0C")}
        ${O("Luftfeuchte",c!=null?String(Math.round(Number(c))):"\u2013","%")}
        ${O("VPD",r!==null?r.toFixed(2):"\u2013","kPa",r===null?void 0:E?u.ok:"#FFD166")}
      </div>
      ...
      ${L?l`<button class="gc logrow" style="width:100%;margin-top:9px;text-align:left"
          ...
          <span class="dot" style="background:${P[L.attributes?.schweregrad]??u.info};flex-shrink:0"></span>
          <span class="txt" style="color:rgba(255,255,255,.6)">${L.state}</span>
        </button>`:d}
      ${this.renderConfirm()}
    </div>`}};customElements.define("growctrl-tent-card",It);var Nt=class extends ${render(){let t=[this.tentSelect(),this.stationSelect(this._config?.tent),p.text("name","Anzeigename (optional)"),p.bool("show_settings","Einstellungen-Zahnrad anzeigen"),p.bool("show_age","Alter-KPI anzeigen (sonst: Pflanzen-Karte)"),p.bool("show_event","Letztes Ereignis am Kartenfuss anzeigen"),p.select("age_format","Alter anzeigen als",[{value:"auto",label:"Automatisch (ab Woche 2 in Wochen)"},{value:"tage",label:"Immer Tage"},{value:"wochen",label:"Immer Wochen"}])],e=[p.text("name","Name"),p.text("strain","Sorte (optional)"),p.entity("germination_helper","Keimstart-Entity (date, optional)","date"),p.entities("sensors","Sensoren dieser Pflanze (optional)","sensor"),p.text("image","Bild-URL (optional)"),p.entity("tank_entity","Tank-F\xFCllstand in % (optional)","sensor"),p.num("tank_min","Tank-Mindeststand % (Standard 30)",0,100)];return l`${this.form(t)}
      ...
      <div class="hint">Entity-IDs werden automatisch abgeleitet
        ...
        per YAML: <code>overrides: { automatik: switch.mein_schalter }</code></div>`}};customElements.define("growctrl-station-editor",Nt);var Ye=["Seedling","Veg","Bloom","Flush","Trocknung"],Bt=class extends x{constructor(){super(...arguments);this._open=!1;this._tab=0}static{this.styles=S}static{this.properties={...x.properties,_open:{state:!0},_tab:{state:!0}}}validateConfig(e){if(!e.tent||!e.station)throw new Error("growctrl-station-card: 'tent' und 'station' sind Pflicht (wie in der Integration angelegt).")}static getConfigElement(){return document.createElement("growctrl-station-editor")}static getStubConfig(){return{tent:"gross",station:"main1"}}get isPreview(){return!this.hass?.states?.[this.e("stage")]}e(e){let[s,i,r]=ze[e],o=this._config;return o.overrides?.[i]??Z(this.hass,o.tent,o.station,r)??bt(s,o.tent,o.station,i,o.overrides)}_select(e,s){this.hass.callService("select","select_option",{entity_id:e,option:s})}render(){let e=this._config;if(!this.hass)return d;let s=this.isPreview,i=this._config.show_age===!0,r=this.st(this.e("stage"))??"Veg",o=mt[r]??mt.Veg,c=this.isOn(this.e("auto"))||s,a=this.isOn(this.e("wartung")),h=[{e:this.e("pOverride"),label:"Manueller Eingriff"},{e:this.e("pFailsafe"),label:"Licht-Failsafe"},{e:this.e("pTime"),label:"Zeiten unvollst\xE4ndig"},{e:this.e("pPump"),label:"Pumpe gesperrt (F\xFCllstand)"},{e:this.e("pPower"),label:"Licht ohne Leistung"}].filter(A=>this.isOn(A.e)),g=this.hass.states[this.e("event")],f=h.length?this.isOn(this.e("pFailsafe"))?"critical":"warning":g?.attributes?.schweregrad==="critical"?"warning":"ok",_=z[f]??z.ok,m=k(this.st(this.e("dli")))??(s?18.4:null),y=k(this.st(this.e("dliFc")))??(s?24.7:null),v=this.hass.states[this.e("dli")]?.attributes?.ziel_aktuelle_phase,L=k(this.st(this.e("age")))??(s?24:null),E=this.st(this.e("rec")),F=!!this.hass.states[this.e("pumpRest")]||s,O=!!this.hass.states[this.e("dli")]||s,b=(F?1:0)+(O?1:0)+(i?1:0),T=(A,U,K,Re)=>l`
      <div class="tile" style="min-width:0">
        <div class="lbl">${A}</div>
        <div style="font-size:19px;font-weight:800;letter-spacing:-.3px;line-height:1.15;
          color:${Re??"rgba(255,255,255,.92)"}">${U}</div>
        ${K?l`<div style="font-size:11px;color:rgba(255,255,255,.6);margin-top:2px">${K}</div>`:d}
      </div>`,C=(A,U)=>l`
      <button class="gc tile" style="text-align:left;min-width:0" @click=${()=>this.moreInfo(A)}>
        <div class="lbl">${U}</div>
      ...
      <div style="display:flex;gap:6px;flex-wrap:wrap;margin-top:12px">
        ${Ye.map(A=>{let U=mt[A],K=A===r;return l`<button class="gc" style="padding:5px 12px;border-radius:10px;font-size:11px;
              font-weight:700;transition:all .15s;
              background:${K?U.bg:"rgba(255,255,255,.04)"};
              border:1.5px solid ${K?U.color:"rgba(255,255,255,.09)"};
              color:${K?U.color:"rgba(255,255,255,.6)"}"
            @click=${()=>this._select(this.e("stage"),A)}>${A}</button>`})}
      </div>

      ${this.lightRow()}

      ${b>0?l`<div class="kpis cols-${Math.min(3,Math.max(2,b))}" style="margin-top:10px">
        ${F?T("Pumpe",s?"12 min":Ot(Number(this.st(this.e("pumpRest")))),s?"Restzeit (Demo)":"Restzeit"):d}
        ${O?T("DLI heute",m!==null?m.toFixed(1):"\u2013",v?`Ziel ${v} \xB7 Prognose ${y!==null?y.toFixed(1):"\u2013"}`:void 0,v&&m!==null&&m>=v?u.ok:void 0):d}
        ${i?T("Alter",L!==null?at(L,e.age_format??"auto"):"\u2013",E&&E!==r?`\u2192 ${E} empfohlen`:this.hass.states[this.e("rec")]?.attributes?.hinweis?"Hinweis \u2013 antippen":"Phase passt",E&&E!==r?"#FFD166":void 0):d}
      </div>`:d}

      ${this.plantTabs()}

      ${h.length?l`<div style="display:flex;gap:6px;flex-wrap:wrap;margin-top:10px">
        ${h.map(A=>l`<span class="badge warn">\u26A0 ${A.label}</span>`)}</div>`:d}

      ${this._config.show_event===!0&&g?l`<button class="gc logrow" style="width:100%;margin-top:10px;text-align:left"
          @click=${()=>this.moreInfo(this.e("event"))}>
          <span class="dot" style="background:${P[g.attributes?.schweregrad==="ok"?"info":g.attributes?.schweregrad]??u.info};flex-shrink:0"></span>
    ...
    </div>`}plantTabs(){let e=this._config.plants??[];if(!e.length)return d;let s=Math.min(this._tab,e.length-1),i=e[s],r=i.germination_helper?this.st(i.germination_helper):null,o=r?ut(r):null;return l`
      <div style="display:flex;gap:6px;flex-wrap:wrap;margin-top:12px">
        ${e.map((c,a)=>l`<button class="gc" style="padding:5px 13px;border-radius:10px;
            ...
            border:1.5px solid ${a===s?u.ok:"rgba(255,255,255,.1)"};
            color:${a===s?u.ok:"rgba(255,255,255,.55)"}"
        ...
        <div style="display:flex;align-items:center;gap:14px">
          ...
          <div style="flex:1;min-width:0">
            ...
            ${o!==null?l`<span style="display:inline-block;margin-top:5px;padding:3px 10px;
                ...
                background:rgba(77,255,195,.12);border:1px solid rgba(77,255,195,.3)">${at(o)}</span>`:d}
          </div>
        </div>
        ${i.sensors?.length?l`
          <div class="kpis cols-${Math.min(3,Math.max(2,i.sensors.length))}" style="margin-top:12px">
            ${i.sensors.map(c=>{let a=k(this.st(c));return l`<button class="gc tile" style="background:rgba(0,0,0,.22);text-align:center"
                  @click=${()=>this.moreInfo(c)}>
                <div class="lbl">${this.friendly(c)}</div>
                <div style="font-size:22px;font-weight:800;letter-spacing:-.4px;margin-top:2px">
                  ${a!==null?a:this.st(c)??"\u2013"}<span class="unit">${this.unit(c)}</span></div>
              </button>`})}
          </div>`:d}
        ${this.plantTank(i)}
      </div>`}plantTank(e){if(!e.tank_entity)return d;let s=Math.min(100,Math.max(0,k(this.st(e.tank_entity))??0)),i=e.tank_min??30,r=s<i,o=r?"#FF6B6B":"#5BC8EF";return l`<div style="margin-top:12px">
      <div style="display:flex;justify-content:space-between;align-items:baseline">
        <span class="lbl">Tank</span>
        <span style="font-size:14px;font-weight:800;color:${o}">${s.toFixed(0)} %
      ...
      <div style="height:9px;border-radius:5px;background:rgba(255,255,255,.08);margin-top:5px;overflow:hidden;position:relative">
        <div style="height:100%;width:${s}%;border-radius:5px;transition:width .6s;
          background:linear-gradient(90deg, ${o}, ${o}cc);box-shadow:0 0 8px ${o}55"></div>
        <div style="position:absolute;top:-1px;bottom:-1px;left:${i}%;width:2px;background:rgba(255,255,255,.45)"></div>
      </div>
    </div>`}};customElements.define("growctrl-station-card",Bt);var ts=[p.text("title","Titel"),p.num("columns","Spalten",1,6)],es=[p.entity("entity","Aktor",["switch","input_boolean","light","fan"]),p.text("name","Name (optional)"),p.text("group","Gruppe (optional, z.B. Zelt / Pflanzen)"),p.bool("confirm","Mit Best\xE4tigung schalten")],Dt=class extends ${render(){return l`${this.form(ts)}
      ${this.list({key:"controls",rowSchema:es,title:"Aktoren",addLabel:"Aktor hinzuf\xFCgen",newItem:()=>({entity:""})})}
      ${this.styleSection()}`}};customElements.define("growctrl-controls-editor",Dt);var ss={switch:"mdi:power",light:"mdi:lightbulb",fan:"mdi:fan",input_boolean:"mdi:toggle-switch"},Ht=class extends x{static{this.styles=S}validateConfig(t){if(!Array.isArray(t.controls)||!t.controls.length)throw new Error("growctrl-controls-card: 'controls' (min. 1 Eintrag) ist Pflicht.")}static getConfigElement(){return document.createElement("growctrl-controls-editor")}static getStubConfig(){return{controls:[{entity:"switch.beispiel"}]}}render(){let t=this._config;if(!this.hass)return d;let e=t.style?.accent??"#4DFFC3",s=new Map;t.controls.forEach(r=>{let o=r.group??"";s.has(o)||s.set(o,[]),s.get(o).push(r)});let i=t.columns?`repeat(${t.columns},1fr)`:"repeat(auto-fill,minmax(92px,1fr))";return l`<div class="card ${t.style?.glass?"glass":""}" style="${w(t.style)};position:relative">
      ...
      <div class="grid" style="grid-template-columns:repeat(${s},1fr)">
        ${e.sensors.map(r=>{let o=k(this.st(r.entity)),c=this.bad(o,r),a=Le(this._hist[r.entity]??[],100,26),h=r.name??this.friendly(r.entity);return l`<button class="gc tile" style="text-align:left;position:relative;overflow:hidden;
      ...
      <div class="grid" style="grid-template-columns:repeat(${e.columns??2},1fr)">
        ${e.plants.map(s=>{let i=s.germination_helper?this.st(s.germination_helper):void 0,r=i?ut(i):null,o=s.camera?this.hass.states[s.camera]?.attributes?.entity_picture?`${this.hass.states[s.camera].attributes.entity_picture}&t=${this._tick}`:void 0:s.image;return l`<div class="tile" style="overflow:hidden">
            ...
            ${r!==null?l`<span style="display:inline-block;margin-top:5px;padding:2px 9px;
              border-radius:7px;font-size:11.5px;font-weight:800;color:#4DFFC3;
              background:rgba(77,255,195,.12);border:1px solid rgba(77,255,195,.3)">${at(r)}</span>`:d}
      ...
      <div style="margin-top:9px">
        ${r.length?r.map(a=>l`
          <div class="logrow" style="background:${a.level==="info"?"transparent":B[a.level]??"transparent"};
            ...
            <span class="txt" style="color:${a.level==="info"?"rgba(255,255,255,.6)":P[a.level]??"rgba(255,255,255,.6)"}">${a.text}</span>
          </div>`):l`<div class="logrow"><span class="txt" style="color:${u.ok}">
            \u2713 Noch keine Ereignisse</span></div>`}
      </div>
    </div>`}};customElements.define("growctrl-status-card",Zt);var cs=[p.text("title","Titel (optional)"),p.text("logo","Logo-URL (z.B. /local/growctrl/logo.png)"),p.bool("show_chart","24h-Chart zus\xE4tzlich zum Zonen-Balken anzeigen"),p.num("hours","Chart-Zeitraum (h)",1,168)],Kt=class extends ${render(){let t=[this.stationSelect(this._config?.tent),p.text("name","Label (optional)")];return l`${this.form([this.tentSelect(),...cs])}
      ${this.list({key:"stations",rowSchema:t,title:"Stationen (Informationssystem)",addLabel:"Station hinzuf\xFCgen",newItem:()=>({station:""})})}
      ${this.styleSection()}`}};customElements.define("growctrl-hero-editor",Kt);var qt=class extends x{constructor(){super(...arguments);this._logoErr=!1;this._hist=[]}static{this.styles=S}static{this.properties={...x.properties,_hist:{state:!0},_logoErr:{state:!0}}}validateConfig(e){if(!e.tent)throw new Error("growctrl-hero-card: 'tent' ist Pflicht (Zelt-Name aus der Integration).")}static getConfigElement(){return document.createElement("growctrl-hero-editor")}static getStubConfig(){return{tent:"gross",stations:[{station:"main1"}]}}te(e){let[s,i,r]=yt[e],o=this._config;return o.overrides?.[i]??Z(this.hass,o.tent,"zelt",r)??xt(s,o.tent,i,o.overrides)}connectedCallback(){super.connectedCallback(),this._load(),this._timer=window.setInterval(()=>this._load(),5*6e4)}disconnectedCallback(){super.disconnectedCallback(),this._timer&&clearInterval(this._timer)}async _load(){if(!this.hass){setTimeout(()=>this._load(),1e3);return}this._hist=await M(this.hass,this.te("vpd"),this._config.hours??24)}render(){let e=this._config;if(!this.hass)return d;let s=this.hass.states[this.te("vpd")],i=!s&&!this.hass.states[this.te("enabled")],r=k(s?.state)??(i?1.06:null),o=s?.attributes?.temp??(i?22.4:null),c=s?.attributes?.rh??(i?52:null),a=s?.attributes?.phase_effektiv??"",h=s?.attributes?.sollwerte,g=this.isOn(this.te("enabled"))||i,f=this.isOn(this.te("climate")),_=this.hass.states[this.te("status")],m=_?.attributes?.probleme??[],y=(e.stations??[]).map(b=>{let T=this.hass.states[Z(this.hass,e.tent,b.station,"last_event")??bt("sensor",e.tent,b.station,"letztes_ereignis",e.overrides)],C=T?.attributes?.schweregrad??"ok";return{name:b.name??b.station,text:T?.state??"\u2013",level:C}}),v=b=>b==="warning"||b==="critical",L=Q([(_?.state??"").toLowerCase()==="problem"?"warning":"ok",...y.map(b=>v(b.level)?b.level:"ok")]),E=z[L],F=[...m.map(b=>({label:b,level:"warning"})),...y.filter(b=>v(b.level)).map(b=>({label:`${b.name}: ${b.text}`,level:b.level}))],O=(b,T,C,A)=>l`
      <button class="gc" style="display:flex;align-items:center;gap:8px;padding:8px 15px;border-radius:14px;
          ...
          color:${C?u.ok:"rgba(255,255,255,.5)"}"
        @click=${()=>this.confirmToggle(b,T)}>
        <ha-icon .icon=${A} style="--mdc-icon-size:16px"></ha-icon>
        <span style="font-size:11px;font-weight:800">${T} ${C?"AN":"AUS"}</span>
      ...
      <div style="display:flex;gap:8px;flex-wrap:wrap;margin-top:13px">
        ...
        ${O(this.te("climate"),"Klima",f,"mdi:thermostat")}
      </div>
      ...
      ${y.length?l`<div class="seclbl">Stationen</div>
        ${y.map(b=>l`<div class="logrow" style="margin-top:3px;padding:6px 9px">
          <span class="dot" style="background:${b.level==="ok"?u.ok:P[b.level]??u.warn};flex-shrink:0"></span>
      ...
      ${F.length?F.map(b=>l`<div class="logrow" style="background:${B[b.level]??B.warning};margin-top:4px">
            <span class="txt" style="color:${P[b.level]??P.warning}">\u26A0 ${b.label}</span></div>`):l`<div class="logrow" style="background:${B.ok};margin-top:4px">
      ...
      <div style="margin-top:10px">
        ${e.map(o=>l`<div class="logrow" style="background:${t.compact?"transparent":B[o.level==="ok"?"none":o.level]};
          ...
          <span class="txt" style="color:${o.level==="ok"?"rgba(255,255,255,.55)":P[o.level]}">${o.label}</span>
          ${o.ts?l`<span class="ts">${o.ts}</span>`:d}
        </div>`)}
      </div>
    </div>`}};customElements.define("growctrl-checkup-card",Qt);var hs=[p.text("title","Titel"),p.entity("entity","F\xFCllstand-Sensor (%) (Pflicht)","sensor"),p.num("min","Mindeststand (%)",0,100),p.num("volume_l","Tankvolumen (Liter, optional)",0,2e3)],Jt=class extends ${render(){return l`${this.form(hs)}${this.styleSection()}`}};customElements.define("growctrl-tank-editor",Jt);var Yt=class extends x{static{this.styles=S}validateConfig(t){if(!t.entity)throw new Error("growctrl-tank-card: 'entity' (Fuellstand-Sensor in %) ist Pflicht.")}static getConfigElement(){return document.createElement("growctrl-tank-editor")}static getStubConfig(){return{entity:"sensor.gc_slot1_level1",title:"Tank"}}render(){let t=this._config;if(!this.hass)return d;let e=!this.hass.states[t.entity],s=Math.min(100,Math.max(0,k(this.st(t.entity))??(e?62:0))),i=t.min!==void 0&&s<t.min,r=i?u.crit:s<(t.min??0)+15?u.warn:"#4FC3F7",o=t.volume_l?s/100*t.volume_l:null;return l`<div class="card ${t.style?.glass?"glass":""}" data-level=${i?"critical":"ok"}
        style=${w(t.style)}>
      <div class="hdr">
