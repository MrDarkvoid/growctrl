  ...
  <div style="display:flex;gap:12px;flex-wrap:wrap;margin-top:4px">
    ...
    <div style="display:flex;justify-content:space-between;font-size:9.5px;
      ...
      ${E?l`<button class="gc logrow" style="width:100%;margin-top:9px;text-align:left"
          ...
          <span class="dot" style="background:${M[E.attributes?.schweregrad]??h.info};flex-shrink:0"></span>
      ...
      ${t.show_event!==!1&&d?l`
        <button class="gc event" @click=${()=>this.moreInfo(this.e("event"))}>
          <span class="edot" style="background:${M[d.attributes?.schweregrad]??"rgba(242,247,243,.4)"}"></span>
          <span class="ebody">
      ...
      ${v.length?l`<div class="seclbl">Stationen</div>
        ${v.map(b=>l`<div class="logrow" style="margin-top:3px;padding:6px 9px">
          <span class="dot" style="background:${b.level==="ok"?h.ok:M[b.level]??h.warn};flex-shrink:0"></span>
      ...
      ${P.length?P.map(b=>l`<div class="logrow" style="background:${N[b.level]??N.warning};margin-top:4px">
            <span class="txt" style="color:${M[b.level]??M.warning}">\u26A0 ${b.label}</span></div>`):l`<div class="logrow" style="background:${N.ok};margin-top:4px">
      ...
      <div style="margin-top:10px">
        ${t.map(s=>l`<div class="logrow" style="background:${e.compact?"transparent":N[s.level==="ok"?"none":s.level]};
          ...
          <span class="txt" style="color:${s.level==="ok"?"rgba(255,255,255,.55)":M[s.level]}">${s.label}</span>
